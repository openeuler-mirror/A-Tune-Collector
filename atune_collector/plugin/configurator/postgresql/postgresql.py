...
"""
The sub class of the Configurator, used to change the postgresql config.
"""
...
class Postgresql(Configurator):
    ...
    def __init__(self, user=None):
        ...
        self.__re = r"^#\?\s*{key}\s* "
        self.__file_dir = "/var/lib/pgsql/data/"
        self.__file_path = self.__file_dir + "postgresql.conf"
